...
function BannerDOT (): React.ReactElement | null {
  ...
  return (
    <Banner type='warning'>
      ...
      <p><Trans key='dotRenom2'><i>New</i> DOT will be 100x smaller than DOT (old). Therefore, your DOT balance will be 100x higher and the price per DOT will be 100x lower. The percentage of the DOT you own relative to total supply will be unchanged. This will not affect the total value of your position.</Trans></p>
